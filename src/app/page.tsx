  ...
  return (
    <div className="min-h-dvh bg-white overflow-x-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4">
              <Link
                href="/register"
                className="inline-flex items-center justify-center px-7 py-3.5 rounded-full bg-primary text-white font-semibold text-sm hover:brightness-110 transition-all shadow-lg shadow-primary/25"
              >
                Start swapping — it&apos;s free
              </Link>
              <Link
                href="/login"
                className="inline-flex items-center justify-center px-7 py-3.5 rounded-full border-2 border-white/30 text-white font-semibold text-sm hover:bg-white/10 transition-colors"
              >
                I already have an account
              </Link>
            </div>

            <div className="mt-10 flex flex-wrap gap-x-4 sm:gap-x-8 gap-y-3 text-sm text-white/50">
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-navy-900">Featured Skills</h2>
            <p className="mt-3 text-gray-500 max-w-md mx-auto">
            ...
            {FEATURED_SKILLS.map((skill) => (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <Link
                    href="/register"
                    className="mt-4 block w-full text-center py-2.5 rounded-lg bg-primary text-white text-sm font-semibold hover:brightness-110 transition-all"
                  >
                    Request Swap
                  </Link>
                </div>
          ...
          <div className="text-center mt-10">
            <Link
              href="/register"
              className="inline-flex items-center px-6 py-3 rounded-full bg-primary text-white font-semibold text-sm hover:brightness-110 transition-all shadow-lg shadow-primary/25"
            >
              View All Skills →
            </Link>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl sm:text-4xl font-bold text-navy-900">What Students Say</h2>
          </div>
      ...
      <section className="py-16 sm:py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/register"
            className="inline-flex items-center mt-8 px-8 py-3.5 rounded-full bg-primary text-white font-semibold text-sm hover:brightness-110 transition-all shadow-lg shadow-primary/25"
          >
            Join Now — It&apos;s Free
          </Link>
        </div>
